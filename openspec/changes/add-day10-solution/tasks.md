...
## 1. Setup Input Files
- [ ] 1.1 Fetch puzzle description from https://adventofcode.com/2025/day/10
- [ ] 1.2 Extract example data from puzzle and save to `inputs/10-example.txt`
- [ ] 1.3 Download real input via `./scripts/download-input.sh 10` to `inputs/10-input.txt`

## 2. Implement Part One
- [ ] 2.1 Create `src/day10.rs` with module documentation following project conventions
...
- [ ] 2.5 Update `src/lib.rs` to declare `day10` module
- [ ] 2.6 Update `src/main.rs` to register day10 puzzle
- [ ] 2.7 Run `cargo test day10` to verify example passes
- [ ] 2.8 Run with real input: `cargo run --release -- 10`
- [ ] 2.9 Submit Part 1 answer via `./scripts/submit-answer.sh 10 1 <answer>` (if unknown)
...
- [ ] 3.4 Run `cargo test day10` to verify tests pass
- [ ] 3.5 Run with real input: `cargo run --release -- 10`
- [ ] 3.6 Submit Part 2 answer via `./scripts/submit-answer.sh 10 2 <answer>` (if unknown)
