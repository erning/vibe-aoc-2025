# Tasks: Add Day 7 Solution

## 1. Setup Input Files
- [x] 1.1 Fetch puzzle description from https://adventofcode.com/2025/day/7
- [x] 1.2 Extract example data from puzzle and save to `inputs/07-example.txt`
- [x] 1.3 Download real input via `./scripts/download-input.sh 7` to `inputs/07-input.txt`

## 2. Implement Part One
- [x] 2.1 Create `src/day07.rs` with module documentation following project conventions
...
- [x] 2.5 Update `src/lib.rs` to declare `day07` module
- [x] 2.6 Update `src/main.rs` to register day07 puzzle
- [x] 2.7 Run `cargo test day07` to verify example passes
- [x] 2.8 Run with real input: `cargo run --release -- 7`
- [x] 2.9 Submit Part 1 answer via `./scripts/submit-answer.sh 7 1 <answer>` (if unknown)
...
- [x] 3.4 Run `cargo test day07` to verify tests pass
- [x] 3.5 Run with real input: `cargo run --release -- 7`
- [x] 3.6 Submit Part 2 answer via `./scripts/submit-answer.sh 7 2 <answer>` (if unknown)
