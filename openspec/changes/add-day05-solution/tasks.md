# Tasks: Add Day 5 Solution

## 1. Setup Input Files
- [x] 1.1 Fetch puzzle description from https://adventofcode.com/2025/day/5
- [x] 1.2 Extract example data from puzzle and save to `inputs/05-example.txt`
- [x] 1.3 Download real input via `./scripts/download-input.sh 5` to `inputs/05-input.txt`

## 2. Implement Part One
- [x] 2.1 Create `src/day05.rs` with module documentation following project conventions
...
- [x] 2.5 Update `src/lib.rs` to declare `day05` module
- [x] 2.6 Update `src/main.rs` to register day05 puzzle
- [x] 2.7 Run `cargo test day05` to verify example passes
- [x] 2.8 Run with real input: `cargo run --release -- 5`
- [x] 2.9 Submit Part 1 answer via `./scripts/submit-answer.sh 5 1 <answer>` (if unknown)
...
- [x] 3.4 Run `cargo test day05` to verify tests pass
- [x] 3.5 Run with real input: `cargo run --release -- 5`
- [x] 3.6 Submit Part 2 answer via `./scripts/submit-answer.sh 5 2 <answer>` (if unknown)
- [x] 3.7 Verify answer is correct; modify implementation is needed
