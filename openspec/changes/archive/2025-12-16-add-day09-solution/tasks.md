# Tasks: Add Day 9 Solution

## 1. Setup Input Files
- [x] 1.1 Fetch puzzle description from https://adventofcode.com/2025/day/9
- [x] 1.2 Extract example data from puzzle and save to `inputs/09-example.txt`
- [x] 1.3 Download real input via `./scripts/download-input.sh 9` to `inputs/09-input.txt`

## 2. Implement Part One
- [x] 2.1 Create `src/day09.rs` with module documentation following project conventions
...
- [x] 2.5 Update `src/lib.rs` to declare `day09` module
- [x] 2.6 Update `src/main.rs` to register day09 puzzle
- [x] 2.7 Run `cargo test day09` to verify example passes
- [x] 2.8 Run with real input: `cargo run --release -- 9`
- [x] 2.9 Submit Part 1 answer via `./scripts/submit-answer.sh 9 1 <answer>` (if unknown)
...
- [x] 3.4 Run `cargo test day09` to verify tests pass
- [x] 3.5 Run with real input: `cargo run --release -- 9`
- [x] 3.6 Submit Part 2 answer via `./scripts/submit-answer.sh 9 2 <answer>` (if unknown)
