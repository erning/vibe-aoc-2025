...
## 1. Setup Input Files
- [ ] 1.1 Fetch puzzle description from https://adventofcode.com/2025/day/6
- [ ] 1.2 Extract example data from puzzle and save to `inputs/06-example.txt`
- [ ] 1.3 Download real input via `./scripts/download-input.sh 6` to `inputs/06-input.txt`

## 2. Implement Part One
- [ ] 2.1 Create `src/day06.rs` with module documentation following project conventions
...
- [ ] 2.5 Update `src/lib.rs` to declare `day06` module
- [ ] 2.6 Update `src/main.rs` to register day06 puzzle
- [ ] 2.7 Run `cargo test day06` to verify example passes
- [ ] 2.8 Run with real input: `cargo run --release -- 6`
- [ ] 2.9 Submit Part 1 answer via `./scripts/submit-answer.sh 6 1 <answer>` (if unknown)
...
- [ ] 3.4 Run `cargo test day06` to verify tests pass
- [ ] 3.5 Run with real input: `cargo run --release -- 6`
- [ ] 3.6 Submit Part 2 answer via `./scripts/submit-answer.sh 6 2 <answer>` (if unknown)
