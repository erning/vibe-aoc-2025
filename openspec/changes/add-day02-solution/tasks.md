...
## 1. Setup Input Files
- [ ] 1.1 Fetch puzzle description from https://adventofcode.com/2025/day/2
- [ ] 1.2 Extract example data from puzzle and save to `inputs/02-example.txt`
- [ ] 1.3 Download real input via `./scripts/download-input.sh 2` to `inputs/02-input.txt`

## 2. Implement Part One
- [ ] 2.1 Create `src/day02.rs` with module documentation following project conventions
...
- [ ] 2.5 Update `src/lib.rs` to declare `day02` module
- [ ] 2.6 Update `src/main.rs` to register day02 puzzle
- [ ] 2.7 Run `cargo test day02` to verify example passes
- [ ] 2.8 Run with real input: `cargo run --release -- 2`
- [ ] 2.9 Submit Part 1 answer via `./scripts/submit-answer.sh 2 1 <answer>` (if unknown)
